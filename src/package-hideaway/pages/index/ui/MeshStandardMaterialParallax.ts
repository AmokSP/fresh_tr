...
export class MeshStandardMaterialParallax extends MeshStandardMaterial {
  ...
  private moveFactorDefaults: Vector2[] = [
  ...
  private beforeCompileModifier = (shader: Shader, renderer: WebGLRenderer) => {
    ...
    shader.uniforms.moveFactor4 = {
      value: this.moveFactors[4] ? this.moveFactors[4] : new Vector2(),
    };
    shader.uniforms.moveFactor5 = {
      value: this.moveFactors[5] ? this.moveFactors[5] : new Vector2(),
    };
    ...
    shader.uniforms.map5 = {
      value: this.textures[4] ? this.textures[4] : DUMMY_TEXTURE,
    };
    shader.uniforms.map6 = {
      value: this.textures[5] ? this.textures[5] : DUMMY_TEXTURE,
    };
    ...
    shader.uniforms.map5Dimensions = {
      value: this.textureDimensions[4]
        ? this.textureDimensions[4]
        : new Vector4(),
    };
    shader.uniforms.map6Dimensions = {
      value: this.textureDimensions[5]
        ? this.textureDimensions[5]
        : new Vector4(),
    };
    ...
    shader.fragmentShader = shader.fragmentShader.replace(
      ...
      `
                    ...
                    ${
                      !(window as any).Main.PREMULTIPLIEDALPHA
